...
import {StockNews, TimeToTimestamp} from "../../../../../../modules/stock/StockSlice";
...
export function News() {
    useEffect(()=>{
        stockMgr().getNews(TimeToTimestamp(Date()),100,0).then((value)=>{
            ...
            {currentNews.map((item,index)=>
                <>
                    <div className={s("news-top")}>
                        <div className={s("left")}>{item.date}</div>
                    </div>
